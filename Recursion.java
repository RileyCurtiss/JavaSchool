...
public class Recursion {
    ...
    public static int longestWordLength(String words){
        ...
        return longestWordLength( words.substring( parse+1, words.length() ));
    }
    ...
    public static String dedupeChars(String word){
        ...
        String upper = word.charAt(word.length()-1)+"";
        upper = upper.toUpperCase();
        String lower = word.charAt(word.length()-1)+"";
        ...
        if ( upper.charAt(0) == word.charAt( word.length()-2 ) ||
             lower.charAt(0) == word.charAt( word.length()-2 ) ) {
            return dedupeChars(word.substring(0,word.length()-1));
        }
