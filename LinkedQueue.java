...
public class LinkedQueue implements MyQueue{
    ...
    public boolean add(String name) {
        if (size == maxCount) {
            throw new IllegalStateException("Its full, bitch");
        }
        Node current = head;
    ...
    public String element() {
        if (size == 0) {
            throw new NoSuchElementException("Stupid fuck there's nothing there");
        }
        String s = head.next.name;
        return s;
    }
    ...
    public String remove() {
        if (size == 0) {
            throw new NoSuchElementException("Stupid Bitch");
        }
        return poll();
    }
    ...
    public static void main(String[] arg){
       ...
       if(!q1.add("1")) {
        ...
        q1.add("2"); //System.out.println("2");
        q1.add("3"); //System.out.println("3");
        q1.add("4"); //System.out.println("4");
