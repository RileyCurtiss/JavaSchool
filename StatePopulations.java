...
public class StatePopulations {
   ...
   public static void main(String[] args) throws IOException {
      ...
      int myZipCode; String statepop="";
      String myAbrev=""; int i;
      ...
      for (i = 0; i < zipCodeState.size(); ++i) {
        // Type: (StatePair<Integer, String>)
        // TO using zipcode, find state abbreviation
        StatePair<Integer, String> holder = zipCodeState.get(i); 
        if (myZipCode == holder.getVal1()) {
            myAbrev = holder.getVal2();
            System.out.println("This is correct, whore");
        }
      }
      
      
      for (i = 0; i < abbrevState.size(); ++i) {
        StatePair<String, String> holder = abbrevState.get(i);
        if (myAbrev.equals(holder.getVal1())) {
            System.out.println("This is correct2, whore");
            statepop = holder.getVal2();
        }
         // TO Using state abbreviation, find state name
      }
      
      
      for (i = 0; i < statePopulation.size(); ++i) {
        StatePair<String, String> holder = abbrevState.get(i);
        if (statepop.equals(holder.getVal1())) {
            System.out.println("This is correct, whore3");
            holder.printInfo();
        } 
         //TO  Using state name, find population. Print pair info.
      }
   }
}
*/