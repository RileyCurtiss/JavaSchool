...
public class StringStack {
    ...
    /* public E push (E ele) {
        NodeGeneric<E> node = new NodeGeneric<E>(ele);
        if (empty()) {
            head = node;
        }
        else {
        ...
        return ele; //return type E, not NodeGeneric<E> 
    }
    ...
    public static void main(String[] args) {
        ...
        stack_ten.push("Alef");
        //System.out.println(stack_ten.toString());
        stack_ten.push("Bet");
        //System.out.println(stack_ten);
